...
var S = {
  init: function () {
    ...
    if (i !== -1) {
      S.UI.simulate(decodeURI(action).substring(i + 56));
    } else {
      S.UI.simulate('Hello dear|JEBA|당신을 기원합니다|생일 축하|জেবা|শুভ জন্মদিন|Happy|26th|Birthday|Lets|Count It|from 26|#countdown 26|Wait a min...');
    }
